export class Localization {
	...
	private static strings: { [key: string]: { vi: string, en: string } } = {
		...
		"wait_opp_action": { vi: "Đang chờ đối thủ...", en: "Waiting for opponent..." },
		...
		"opp_left_win": { vi: "Đối thủ đã rời phòng! Bạn thắng!", en: "Opponent left! You win!" },
		"p_lose": { vi: "Player {0} thua!", en: "Player {0} lost!" },
		"you_lose": { vi: "Game Over!", en: "Game Over!" },
		"you_win": { vi: "Chúc mừng! Bạn đã thắng.", en: "Congratulations! You won." },
